...
const sr = ScrollReveal ({
  ...
  sr.reveal('.myimageabout',{ delay:200, origin:'left' })
  sr.reveal('.about-text-content',{ delay:200, origin:'right' })
  sr.reveal('.home-image',{ delay:200, origin:'left' })
  sr.reveal('.home-text-content',{ delay:200, origin:'right' })
  ...
  sr.reveal('.menu-food-content',{ delay:100, origin:'top' })
  sr.reveal('.menu-content',{ delay:100, origin:'top' })
